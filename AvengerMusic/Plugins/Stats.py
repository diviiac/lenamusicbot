...
from AvengerMusic.Database import get_gbans_count, get_served_chats, get_sudoers
from AvengerMusic.Inline import stats1, stats2, stats3, stats4, stats5, stats6, stats7
...
@app.on_message(filters.command("static") & ~filters.edited)
