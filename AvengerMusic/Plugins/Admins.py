...
from AvengerMusic.Core.PyTgCalls.Avenger import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from AvengerMusic.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from AvengerMusic.Decorators.admins import AdminRightsCheck
from AvengerMusic.Decorators.checker import checker, checkerCB
from AvengerMusic.Inline import audio_markup, primary_markup, secondary_markup2
